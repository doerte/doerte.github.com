...
\section{Education}
%
\textbf{University of Groningen, The Netherlands} \hfill September 2007 to present
\begin{outerlist}
\item[]Ph.D.,
        \href{http://www.let.rug.nl/neurolinguistics/}
             ...
             expected fall 2011
        \begin{innerlist}
        \item Thesis Topic: \emph{The influence of speechreading on (aphasic) language comprehension and brain responses}
        \item Advisers:
 		\begin{itemize}             
...
\item Hessler, D., Jonkers, R., Stowe,L. and Bastiaanse, R. (2011). Processing of phonemic contrasts – an ERP study. Talk to be given at `Science of Aphasia XII', Barcelona (Spain). 

\item Hessler, D., Jonkers, R., Stowe, L. and Bastiaanse, R. (2011). The psychological reality of phonemic contrasts. Talk to be given at the `32\textsuperscript{nd} TABU Dag', Groningen (The Netherlands). 
...
%
\textbf{Neurological Rehabilitation Center Beelitz-Heilst\"{a}tten, Germany}

\begin{outerlist}
	\item[] \textit{Temporary speech and language therapist} \hfill {\small \textbf{March 2005 to May 2005}}
	\begin{innerlist}
	\item Diagnosis and treatment of patients with aphasia, apraxia of speech and dysarthria.
	\end{innerlist}

\item[] \textit{Intern speech and language therapy} \hfill {\small\textbf{September 2004 to November 2004}}
	\begin{innerlist}
	\item Oberservation and supervised execution of diagnosis and treatment of patients with aphasia, apraxia of speech and dysarthria.\\
	\end{innerlist}
\end{outerlist}

\halfblankline

\textbf{Speech and Language Therapy Office Rohloff, Genthin, Germany},
\begin{outerlist}

\item[] \textit{Intern speech and language therapy}%
        \hfill \small{\textbf{December 2004 to February 2005}}
\begin{innerlist}
\item Observation and supervised execution of diagnosis and treatment of developmental speech and language disorders and myofunctional disorders.
\end{innerlist}
...
\item Linux (Debian, Ubuntu) - basic knowledge
\end{innerlist}                                 
...
\textbf{French}: basic knowledge (UNIcert\textsuperscript{\copyright} I)\\
\textbf{Latin}: basic knowledge in written modality

\section{Hobbies and interests}
%
Singing in a choir, indoor soccer, Zumba, reading (novels), acquiring new computer skills (e.g. learning to program)\\

\blankline
 
\hspace{-33.5mm} Groningen, \formatdate{03}{05}{2011} 
